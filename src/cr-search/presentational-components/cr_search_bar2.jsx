...
function CRSearchBar(props) {
    ...
    return (
        <DynamicGrid defaultTemplate={CRSearchBarTemplate.template.defaultTemplate}
            ...
            small={CRSearchBarTemplate.template.small}
            medium={CRSearchBarTemplate.template.medium}
            large={CRSearchBarTemplate.template.large}
            huge={CRSearchBarTemplate.template.huge}>
            <DynamicGrid.Region {...CRSearchBarTemplate.region1}>
            ...
            <DynamicGrid.Region {...CRSearchBarTemplate.region2}>
                <Radio onChange={onSearchTypeChange} id="second-inline" value='keyword' labelText="Search By Keyword" name="inline-example" isInline />            </DynamicGrid.Region>
            <DynamicGrid.Region {...CRSearchBarTemplate.region3}>
                ...
                </Tooltip>            </DynamicGrid.Region>
            <DynamicGrid.Region {...CRSearchBarTemplate.region4}>
            ...
            <DynamicGrid.Region {...CRSearchBarTemplate.region5}>
            ...
            <DynamicGrid.Region {...CRSearchBarTemplate.region6} className="connect_btn_grid">
                <Button className="connect_btn" onClick={() => handleSearchConnect(cr_number)} icon={<IconSearch />} text="CONNECT" variant="emphasis" />
            </DynamicGrid.Region>
            <DynamicGrid.Region {...CRSearchBarTemplate.region7}>
                {collapseBox ?
            ...
            <DynamicGrid.Region {...CRSearchBarTemplate.region8}>
                {collapseBox ?
                    ...
                    : ''}            </DynamicGrid.Region>
            <DynamicGrid.Region {...CRSearchBarTemplate.region9}>
                {collapseBox ?
            ...
            <DynamicGrid.Region {...CRSearchBarTemplate.region12}>
                {collapseBox ?
            ...
            <DynamicGrid.Region {...CRSearchBarTemplate.region13}>
            ...
            {loader ? <DynamicGrid.Region {...CRSearchBarTemplate.region14} >
